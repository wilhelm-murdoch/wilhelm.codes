...
* Proper RSS feeds for both [long-form articles](/articles.xml) and [bits](/bits.xml). Check the footer!
* A quick sweep of the [site map](/sitemap.xml) to ensure everything maps out properly. There were a few dead links previously.
* You can now filter bits by type! Have a play with it at the top of [this](/bits) page.
